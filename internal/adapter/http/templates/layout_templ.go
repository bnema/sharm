...
func Layout(props LayoutProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ShowNav {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/http/templates/layout.templ`, Line: 508, Col: 40}
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, ">Library</a> <a href=\"/upload\" class=\"nav-link\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		if props.ShowNav {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<footer class=\"footer\"><span>MIT</span> <span class=\"sep\">&middot;</span> <a href=\"https://bnema.dev\" target=\"_blank\" rel=\"noopener\">bnema</a> <span class=\"sep\">&middot;</span> <a href=\"https://github.com/bnema/sharm\" target=\"_blank\" rel=\"noopener\">GitHub</a></footer><!-- Mobile bottom navigation --> <nav class=\"bottom-nav\" aria-label=\"Mobile navigation\"><a href=\"/\" class=\"bottom-nav-item\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if props.ActiveRoute == "dashboard" {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<span>Library</span></a> <a href=\"/upload\" class=\"bottom-nav-item\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if props.ActiveRoute == "upload" {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<span>Upload</span></a> <button class=\"bottom-nav-item\" onclick=\"document.getElementById('password-dialog').showModal()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<span>Password</span></button><form action=\"/logout\" method=\"post\" style=\"display:contents;\"><button type=\"submit\" class=\"bottom-nav-item bottom-nav-item--danger\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<span>Logout</span></button></form></nav>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
