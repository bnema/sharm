...
func TestMediaService_Upload_VideoNoCodecs(t *testing.T) {
	...
	service := NewMediaService(mockStore, mockConverter, mockJobQueue, tempDir, nopLogger{})
...
func TestMediaService_Upload_CreateDirectoryFails(t *testing.T) {
	...
	service := NewMediaService(mockStore, mockConverter, mockJobQueue, "/invalid/path/that/cannot/be/created/\x00", nopLogger{})
